<?php /* Smarty version Smarty-3.1.19, created on 2016-01-03 11:27:19
         compiled from "/var/www/pacxs.local/public_html/themes/leoconv/address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8468341675688f7877bf0a2-87807194%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f76b3f214a8348138362cdc885e6f1c3a51f2494' => 
    array (
      0 => '/var/www/pacxs.local/public_html/themes/leoconv/address.tpl',
      1 => 1448906178,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8468341675688f7877bf0a2-87807194',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5688f7879f63a6_64283882',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5688f7879f63a6_64283882')) {function content_5688f7879f63a6_64283882($_smarty_tpl) {?>
...
<p class="required"><sup>* <?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</sup></p>
...
<?php }?><?php }?></textarea>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>
			<div class="inline-infos required control-group">
				<div class="controls">
					<?php echo smartyTranslate(array('s'=>'You must register at least one phone number.'),$_smarty_tpl);?>
 <sup>*</sup>
				</div>
			</div>
		<?php }?>
...
<?php }?><?php }?>" />
		...
		<div class="required text control-group" id="adress_alias">
			<label for="alias" class="control-label"><?php echo smartyTranslate(array('s'=>'Please assign an address title for future reference.'),$_smarty_tpl);?>
 <sup>*</sup></label>
			<div class="controls">
