<?php /* Smarty version Smarty-3.1.19, created on 2016-01-03 11:20:21
         compiled from "/var/www/pacxs.local/public_html/admin123/themes/default/template/controllers/stock_cover/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1817794655688f5e59a1538-63997808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '350f87c7c4df844750f2423ec85c2a9d7d47ba2f' => 
    array (
      0 => '/var/www/pacxs.local/public_html/admin123/themes/default/template/controllers/stock_cover/helpers/list/list_header.tpl',
      1 => 1447585407,
      2 => 'file',
    ),
    '1cc724d28a654631b5ec2db423ae870cd406ac43' => 
    array (
      0 => '/var/www/pacxs.local/public_html/admin123/themes/default/template/helpers/list/list_header.tpl',
      1 => 1447585407,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1817794655688f5e59a1538-63997808',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5688f5e5ca5ff6_23100006',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5688f5e5ca5ff6_23100006')) {function content_5688f5e5ca5ff6_23100006($_smarty_tpl) {?>
...
" />
			...
			<div class="form-group">
				<label for="coverage_period" class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Filter by period:'),$_smarty_tpl);?>
</label>
				<div class="col-lg-9">
...
"><?php echo $_smarty_tpl->tpl_vars['i']->value['name'];?>
			...
			<?php }?>
			<div class="form-group">
				<label for="warn_days" class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Highlight when coverage (in days) is less than:'),$_smarty_tpl);?>
</label>
				<div class="col-lg-9">
					<input id="warn_days" name="warn_days" type="text" size="3" onchange="$('#stock_cover').submit();" value="<?php if (isset($_smarty_tpl->tpl_vars['stock_cover_warn_days']->value)) {?><?php echo $_smarty_tpl->tpl_vars['stock_cover_warn_days']->value;?>
<?php }?>" />
				</div>
			</div>
		</form>
