<?php /* Smarty version Smarty-3.1.19, created on 2016-01-03 11:25:38
         compiled from "/var/www/pacxs.local/public_html/themes/leoconv/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17812084065688f722325f26-00292706%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc538de2e45ccdddef9912d4fe28446c76cb1db0' => 
    array (
      0 => '/var/www/pacxs.local/public_html/themes/leoconv/authentication.tpl',
      1 => 1448906178,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17812084065688f722325f26-00292706',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5688f7226e3c05_31368199',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5688f7226e3c05_31368199')) {function content_5688f7226e3c05_31368199($_smarty_tpl) {?>
...
" /><?php }?>
						<input type="submit" id="SubmitCreate" name="SubmitCreate" class="button_large btn" value="<?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
" />
...
<?php }?>" class="account_input" /></span>
					...
					<p class="submit">
						<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" /><?php }?>
						<input type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn" value="<?php echo smartyTranslate(array('s'=>'Log in'),$_smarty_tpl);?>
" />
					</p>
		...
		<fieldset>
			...
			<div id="opc_account_form" style="display: block; ">
				...
				<div class="required text control-group">
					<label class="control-label" for="guest_email"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="controls">
...
" class="top help-inline"><?php echo $_smarty_tpl->tpl_vars['gender']->value->name;?>
</label>
					<?php } ?>
					</div>
				</div>
...
<?php }?>" />
				...
				<div class="select control-group">
					...
					<span class="control-label"><?php echo smartyTranslate(array('s'=>'Date of Birth'),$_smarty_tpl);?>
</span>
					<div class="controls">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['newsletter']->value)&&$_smarty_tpl->tpl_vars['newsletter']->value) {?>
					<div class="checkbox control-group">
						...
						<div class="controls">
							...
							<label class="help-inline" for="newsletter"><?php echo smartyTranslate(array('s'=>'Sign up for our newsletter!'),$_smarty_tpl);?>
</label>
						</div>
					</div>
					<div class="checkbox control-group">
						...
						<div class="controls">
							...
							<label class="help-inline" for="optin"><?php echo smartyTranslate(array('s'=>'Receive special offers from our partners!'),$_smarty_tpl);?>
</label>
						</div>
					</div>
				<?php }?>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['field_name']->value=="company") {?>
						<div class="text control-group">
							<label class="control-label" for="company"><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
</label>
							<div class="controls">
...
<?php }?>" />
						...
						<div id="vat_number" style="display:none;">
							<div class="text control-group">
								<label class="control-label" for="vat_number"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
</label>
								<div class="controls">
...
" <?php if (($_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
 ...
 <sup>*</sup></label>
						...
						<div class="<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>required <?php }?>text control-group">
							<label for="phone" class="control-label" ><?php echo smartyTranslate(array('s'=>'Phone'),$_smarty_tpl);?>
...
<?php }?>" />
				<span class="form_info help-inline"><?php echo smartyTranslate(array('s'=>'DNI / NIF / NIE'),$_smarty_tpl);?>
</span>
				</div>
			</div>
		</fieldset>
		...
		<p class="cart_navigation required submit">
			<span><sup>* <?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</sup></span>
			<input type="hidden" name="display_guest_checkout" value="1" />
			<input type="submit" class="exclusive btn" name="submitGuestAccount" id="submitGuestAccount" value="<?php echo smartyTranslate(array('s'=>'Continue'),$_smarty_tpl);?>
" />
		</p>
	</form>
	<?php }?> 
...
<?php }?>" />
		...
		<div class="required text control-group">
			<label for="email" class="control-label" ><?php echo smartyTranslate(array('s'=>'Email'),$_smarty_tpl);?>
 <sup>*</sup></label>
			<div class="controls">
...
<?php }?>" />
		...
		<div class="required password control-group">
			<label for="passwd" class="control-label" ><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
 <sup>*</sup></label>
			<div class="controls">
				<input type="password" class="text  " name="passwd" id="passwd" />
				<span class="form_info help-inline"><?php echo smartyTranslate(array('s'=>'(Five characters minimum)'),$_smarty_tpl);?>
</span>
			</div>
		</div>
		<div class="select control-group">
...
&nbsp;&nbsp;</option>
		...
		<div class="checkbox control-group" >
			...
			<div class="controls">
				<input type="checkbox" name="newsletter" id="newsletter" value="1" <?php if (isset($_POST['newsletter'])&&$_POST['newsletter']==1) {?> checked="checked"<?php }?> />
				<label for="newsletter" class="help-inline"><?php echo smartyTranslate(array('s'=>'Sign up for our newsletter!'),$_smarty_tpl);?>
</label>
			</div>
		</div>
		<div class="checkbox control-group" >
			...
			<div class="controls">
				<input type="checkbox"name="optin" id="optin" value="1" <?php if (isset($_POST['optin'])&&$_POST['optin']==1) {?> checked="checked"<?php }?> />
				<label for="optin" class="help-inline"><?php echo smartyTranslate(array('s'=>'Receive special offers from our partners!'),$_smarty_tpl);?>
</label>
			</div>
		</div>
		<?php }?>
	...
	<fieldset class="account_creation">
		...
		<div class="text control-group">
			<label for="" class="control-label" ><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
</label>
			<div class="controls">
				<input type="text" class="text  " id="company" name="company" value="<?php if (isset($_POST['company'])) {?><?php echo $_POST['company'];?>
<?php }?>" />
		...
		<div class="text control-group">
			<label for="siret" class="control-label" ><?php echo smartyTranslate(array('s'=>'SIRET'),$_smarty_tpl);?>
</label>
			<div class="controls">
...
<?php }?>" />
		...
		<div class="text control-group">
			<label for="ape" class="control-label" ><?php echo smartyTranslate(array('s'=>'APE'),$_smarty_tpl);?>
</label>
			<div class="controls">
...
<?php }?>" />
		...
		<div class="text control-group">
			<label for="website"  class="control-label" ><?php echo smartyTranslate(array('s'=>'Website'),$_smarty_tpl);?>
</label>
			<div class="controls">
...
<?php }?>" />
 ...
 <sup>*</sup></label>
					<div class="controls">
						<input type="text" class="text  " name="address1" id="address1" value="<?php if (isset($_POST['address1'])) {?><?php echo $_POST['address1'];?>
<?php }?>" />
						<span class="inline-infos help-inline"><?php echo smartyTranslate(array('s'=>'Street address, P.O. Box, Company name, etc.'),$_smarty_tpl);?>
</span>
					</div>
				</div>
...
<?php }?>" />
						<span class="inline-infos help-inline"><?php echo smartyTranslate(array('s'=>'Apartment, suite, unit, building, floor, etc...'),$_smarty_tpl);?>
</span>
					</div>
				</div>
			<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="postcode") {?>
...
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?><?php }?></label>
			<div class="controls">
...
<?php }?>" />
		...
		<div class="required text control-group" id="address_alias">
			<label for="alias" class="control-label" ><?php echo smartyTranslate(array('s'=>'Assign an address alias for future reference.'),$_smarty_tpl);?>
 <sup>*</sup></label>
			<div class="controls">
