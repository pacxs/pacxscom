<?php /* Smarty version Smarty-3.1.19, created on 2015-12-02 14:11:53
         compiled from "/var/www/pacxs.local/public_html/themes/fashionbird/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1207391641565eee195d6688-80033821%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a579310e2bb950ef60d44bc75541d5b092c1da7' => 
    array (
      0 => '/var/www/pacxs.local/public_html/themes/fashionbird/contact-form.tpl',
      1 => 1448915166,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1207391641565eee195d6688-80033821',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565eee19739877_94096618',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565eee19739877_94096618')) {function content_565eee19739877_94096618($_smarty_tpl) {?>
...
" class="desc_contact" style="display:none;">
			...
			<p class="text">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['email'])) {?>
					<input type="email" id="email" name="from" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['customerThread']->value['email'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" readonly="readonly" />
				<?php } else { ?>
					<input type="email" id="email" name="from" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['email']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
				<?php }?>
			</p>
